...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provided by nvim-cmp (disabled with nvim-cmp; pcall fallback handles absence)
    ...
    config = function()
      ...
      --  Fall back to core defaults while testing if nvim-cmp is the crash trigger.
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        javascriptreact = isatwork and { 'trim_whitespace' } or { 'prettierd', 'prettier', 'deno_fmt', stop_after_first = true },
        typescript = isatwork and { 'trim_whitespace' } or { 'prettierd', 'prettier', 'deno_fmt', stop_after_first = true },
        typescriptreact = isatwork and { 'trim_whitespace' } or { 'prettierd', 'prettier', 'deno_fmt', stop_after_first = true },
  ...
  { -- Autocompletion (migrated from blink.cmp; blink crashed on this setup)
    'hrsh7th/nvim-cmp',
    enabled = false, -- Silently crashes the TUI on type. Same as blink. Unknown root cause; out of debug budget.
    event = 'InsertEnter',
    dependencies = {
      -- Snippet Engine
      {
